...
class Character:
    ...
    def __init__(self, book_id, character_id, name, gender, descent_country, descent_city, living_country, living_city, age, education):
        self.namevariants = []
...
class Character_Centrality(Character):
    def __init__(self, book_id, character_id, name, gender, descent_country, descent_city, living_country, living_city, age, education, degree, betweenness, closeness, eigenvector, katz):
        Character.__init__(self, book_id, character_id, name, gender, descent_country, descent_city, living_country, living_city, age, education)
        self.degree = degree
...
class Book:
    ...
    def addcharacter(self, book_id, character_id, name, gender, descent_country, descent_city, living_country, living_city, age, education):
        """ Adds instances of Character to instances of Book

        """
        
        self.allcharacters[character_id] = Character(book_id, character_id, name, gender, descent_country, descent_city, living_country, living_city, age, education)
    ...
    def split_multinovel(self):
        ...
        if patterns:
            for pat in patterns:
                ...
                for character_id in self.allcharacters:
                    #subbook.addcharacter(self.allcharacters[character].book_id, self.allcharacters[character].character_id, self.allcharacters[character].name, self.allcharacters[character].gender, self.allcharacters[character].descent_country, self.allcharacters[character].descent_city, self.allcharacters[character].living_country, self.allcharacters[character].living_city, self.allcharacters[character].age, self.allcharacters[character].education)
...
class Network(): 
    ...
    def __init__(self, book_id, word_count, gender_author, age_author):
        ...
        self.descent_recode_assortativity = 0
        self.communities = []
    ...
    def compute_networkstats(self, filename='networkstats_permutation.csv'):
        """
